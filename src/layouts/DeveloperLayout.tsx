...
const DeveloperLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Profile', path: '/developer-dashboard/profile', icon: User },
  ];
    ...
    <div className="flex min-h-screen bg-zinc-50 font-['Outfit'] lg:pl-64">
      ...
      <aside className={cn(
        ...
        <div className="relative">
          <SidebarHeader portalName="Developer Portal" />
          <button 
      ...
      <main className="flex-1 flex flex-col min-h-screen w-full">
        ...
        <GlobalHeader 
          ...
          userName={profile?.name || "Senior Developer"}
          userInitials={profile?.name ? profile.name.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2) : "D"}
          showProfile={false}
        />
